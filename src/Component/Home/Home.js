    ...
    <div>
      <div style={{ display: 'flex', marginLeft: '50px', marginTop: 13 }}>
        <div className='introContainer'>
          <div style={{ width: '30%' }}>
            <p style={{ textAlign: 'start', color: 'white', marginLeft: 15 }}>
              Hy! Suman
            </p>
            <p
              style={{
        ...
        <div className='itemsContainer'>
          <p style={{ textAlign: 'start', marginLeft: '40px', color: 'white' }}>
            Statistics
          </p>
          <div style={{ display: 'flex', marginLeft: '40px' }}>
            ...
            >
              ...
              >
                <img
                  src={`${RevenueLogo}`}
                  style={{ width: '25px', height: '25px', marginTop: 7 }}
                  alt=''
                />
              </div>
              <div>
        ...
        <div style={{ width: '38%', marginLeft: '50px', marginTop: '20px' }}>
          ...
          >
            <div style={{ width: '34%' }}>
              ...
              >
                622% more earning than previous month
              </p>
              <button
                style={{
                  paddingLeft: '25px',
